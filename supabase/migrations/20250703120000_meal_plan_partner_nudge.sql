-- Push partners to update the shared meal plan for the current week.

create or replace function public.nudge_household_meal_plan(
    p_household_id uuid,
...
revoke all on function public.nudge_household_meal_plan(uuid, text) from public;
grant execute on function public.nudge_household_meal_plan(uuid, text) to authenticated;
