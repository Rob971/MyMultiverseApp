-- Invite deep-link foundation: token-based preview RPC + invite_token in notification outbox.
...
grant execute on function public.preview_household_invite(text) to anon;
