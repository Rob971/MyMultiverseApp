...
import app.mymultiverse.ammo.presentation.components.PendingInvitesCard
import app.mymultiverse.ammo.presentation.theme.AppIcons
import app.mymultiverse.ammo.domain.repository.AuthRepository
import app.mymultiverse.ammo.domain.auth.avatarInitials
import app.mymultiverse.ammo.domain.model.auth.AuthState
import app.mymultiverse.ammo.presentation.components.UserAvatarButton
        ...
        HomePhase.Welcome -> {
            ...
            Scaffold(
                ...
                HomeWelcomeContent(
                    ...
                    homeHubActionsModifier = Modifier.productTourTarget(
...
private fun HomeInviteSnackbarEffects(
    ...
    pendingInvites: List<app.mymultiverse.ammo.domain.model.sharing.HouseholdInvite>,
    sessionEmail: String,
    personalDataExportMessage: PersonalDataExportMessage?,
    deleteAccountMessage: DeleteAccountMessage?,
...
fun HomeWelcomeContent(
    ...
    homeHubActionsModifier: Modifier = Modifier,
    modifier: Modifier = Modifier,
) {
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            HomeDailyHubCircularActions(
                                onOpenMealPlan = onOpenMealPlan,
                                onOpenGrocery = onOpenGrocery,
                                modifier = homeHubActionsModifier,
                            )
                        }
                        Column(
                            modifier = Modifier.weight(1f),
