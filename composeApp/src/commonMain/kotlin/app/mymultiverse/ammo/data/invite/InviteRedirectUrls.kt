...
object InviteRedirectUrls {
    const val SCHEME = "app.mymultiverse.ammo"
    ...
    /** Supabase custom domain (API + invite-open edge fallback). */
    const val HTTPS_HOST_SUPABASE = "ammo.mymultiverse.app"
    ...
    private fun isAllowedHttpsHost(host: String): Boolean =
        host.equals(HTTPS_HOST_PRIMARY, ignoreCase = true) ||
            host.equals(HTTPS_HOST_SUPABASE, ignoreCase = true) ||
