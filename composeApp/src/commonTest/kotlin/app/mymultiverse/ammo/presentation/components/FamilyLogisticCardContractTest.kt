...
class FamilyLogisticCardContractTest {
    ...
    private fun readComponentSource(fileName: String): String =
        readProjectFile("composeApp/src/commonMain/kotlin/app/mymultiverse/ammo/presentation/components/$fileName")

    private fun readScreenSource(fileName: String): String =
        readProjectFile("composeApp/src/commonMain/kotlin/app/mymultiverse/ammo/presentation/screens/nutrition/$fileName")

    private fun readPresentationSource(fileName: String): String =
        readProjectFile("composeApp/src/commonMain/kotlin/app/mymultiverse/ammo/presentation/$fileName")

    private fun readIosEntrySource(): String =
        readProjectFile("composeApp/src/iosMain/kotlin/app/mymultiverse/ammo/IosEntryPoint.kt")
