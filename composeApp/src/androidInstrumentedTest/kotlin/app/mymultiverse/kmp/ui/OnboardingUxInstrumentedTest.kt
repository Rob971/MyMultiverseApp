...
import app.mymultiverse.kmp.presentation.screens.auth.LoginTestTags
import app.mymultiverse.kmp.presentation.screens.householdsetup.HouseholdCreationScreen
import app.mymultiverse.kmp.presentation.screens.householdsetup.HouseholdCreationTestTags
...
import app.mymultiverse.kmp.presentation.screens.onboarding.AuthTestTags
    ...
    fun householdCreation_createDisabledUntilNameAvailable() {
        ...
        composeRule.waitFor(timeoutMillis = 3_000) {
            screenModel.uiState.value.nameAvailability ==
                app.mymultiverse.kmp.presentation.screens.home.HouseholdNameAvailability.Available
        }
